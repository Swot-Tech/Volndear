...
namespace Volndear.Droid
{
	...
	public class NavigationDrawer : ActionBarActivity
	{
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			mToolbar = FindViewById & lt; SupportToolbar & gt; (Resource.Id.toolbar);
			mDrawerLayout = FindViewById & lt; DrawerLayout & gt; (Resource.Id.drawer_layout);
			mLeftDrawer = FindViewById & lt; ListView & gt; (Resource.Id.left_drawer);
			homeFragment = new HomeFragment();

			profileFragment = new ProfileFragment();
			mStackFragments = new Stack& lt; SupportFragment & gt; ();
			...
			mLeftDataSet = new List& lt; string&gt; ();
			mLeftDataSet.Add("Left Item 1");
			mLeftDataSet.Add("Left Item 2");
			mLeftAdapter = new ArrayAdapter& lt; string&gt; (this, Android.Resource.Layout.SimpleListItem1, mLeftDataSet);
